<?php
	...
	$query = "SELECT * FROM tbl_mata_pelajaran INNER JOIN tbl_guru ON tbl_mata_pelajaran.nip = tbl_guru.nip ORDER BY tbl_mata_pelajaran.id_mata_pelajaran ASC, tbl_guru.nip ASC, tbl_mata_pelajaran.kelas ASC LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
	<div class="panel-heading">
							...
							while($data = $sql->fetch()){
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-warning" href="?page=nilai_mata_pelajaran&aksi=detail_nilai_mata_pelajaran&id=<?php echo $data['kelas'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>">Lihat Nilai</a></td>
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_mata_pelajaran INNER JOIN tbl_guru ON tbl_mata_pelajaran.nip = tbl_guru.nip ORDER BY tbl_mata_pelajaran.id_mata_pelajaran ASC, tbl_guru.nip ASC, tbl_mata_pelajaran.kelas ASC");
