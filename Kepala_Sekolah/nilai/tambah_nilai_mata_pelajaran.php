...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Update Tugas Mata Pelajaran</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=nilai_mata_pelajaran&aksi=simpandata_tugas_mata_pelajaran" method="POST">
						<div class="form-group">
							...
							<select class="form-control" name="id_tugas_mata_pelajaran">
								<?php
									$query_tugas = "SELECT * FROM tbl_tugas_mata_pelajaran INNER JOIN tbl_mata_pelajaran ON tbl_tugas_mata_pelajaran.id_mata_pelajaran = tbl_mata_pelajaran.id_mata_pelajaran ORDER BY tbl_mata_pelajaran.id_mata_pelajaran ASC";
