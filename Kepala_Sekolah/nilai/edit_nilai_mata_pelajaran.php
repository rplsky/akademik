				...
				<div class="col-md-6" >
					<form action="?page=tugas_mata_pelajaran&aksi=updatedata_tugas_mata_pelajaran" method="POST">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="isi_tugas_mata_pelajaran" placeholder="Isi Tugas Mata Pelajaran" required><?php echo $data['isi_tugas_mata_pelajaran'];?></textarea>
						</div>					
						<div class="form-group">
							<label>Bobot</label>
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" name="batas_pengumpulan" value="<?php echo $data['batas_pengumpulan'];?>" required placeholder="Batas Pengumpulan"/>
						</div>
