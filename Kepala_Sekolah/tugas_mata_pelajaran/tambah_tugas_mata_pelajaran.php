				...
				<div class="col-md-6" >
					<form action="?page=tugas_mata_pelajaran&aksi=simpandata_tugas_mata_pelajaran" method="POST">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="isi_tugas_mata_pelajaran" placeholder="Isi Tugas Mata Pelajaran" required></textarea>
						</div>					
						<div class="form-group">
							<label>Bobot</label>
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" name="batas_pengumpulan" required placeholder="Batas Pengumpulan"/>
						</div>
