...
--
-- Host: localhost:3306
-- Waktu pembuatan: 30 Sep 2021 pada 22.11
...
--
-- Indeks untuk tabel `tbl_jawaban_ujian`
--
ALTER TABLE `tbl_jawaban_ujian`
  ADD PRIMARY KEY (`id_jawaban_ujian`);

--
-- Indeks untuk tabel `tbl_kepala_sekolah`
--
ALTER TABLE `tbl_kepala_sekolah`
  ADD PRIMARY KEY (`nip`);

--
-- Indeks untuk tabel `tbl_kumpul_tugas`
--
ALTER TABLE `tbl_kumpul_tugas`
  ADD PRIMARY KEY (`id_kirim`);

--
-- Indeks untuk tabel `tbl_lembar_ujian`
--
...
--
-- Indeks untuk tabel `tbl_nilai_mata_pelajaran`
--
...
--
-- Indeks untuk tabel `tbl_tugas_mata_pelajaran`
--
ALTER TABLE `tbl_tugas_mata_pelajaran`
  ADD PRIMARY KEY (`id_tugas_mata_pelajaran`);

--
-- Indeks untuk tabel `tbl_wks_kurikulum`
--
