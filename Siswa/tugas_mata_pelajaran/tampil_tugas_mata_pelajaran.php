<?php
	...
	$query = "SELECT * FROM tbl_tugas_mata_pelajaran INNER JOIN tbl_siswa INNER JOIN tbl_mata_pelajaran ON tbl_tugas_mata_pelajaran.id_mata_pelajaran = tbl_mata_pelajaran.id_mata_pelajaran WHERE tbl_mata_pelajaran.id_mata_pelajaran = '$id' AND tbl_siswa.nis = '$nip' AND tbl_tugas_mata_pelajaran.tgl_tugas <= '$tgl_skrang' AND tbl_tugas_mata_pelajaran.batas_pengumpulan >= '$tgl_skrang' ORDER BY tbl_tugas_mata_pelajaran.id_tugas_mata_pelajaran DESC LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
						...
						<div class="col-lg-4 col-xs-12">
					          ...
					          <div class="small-box bg-blue">
					            ...
					            <p class="small-box-footer bg-dark">
					                <a href="?page=tugas_mata_pelajaran&aksi=detail_tugas&id=<?php echo $data['id_mata_pelajaran']; ?>&idtugas=<?php echo $data['id_tugas_mata_pelajaran']; ?>" class="btn__ btn btn-success">Buka Tugas</a>
					            </p>     
					            </div>
					     </div>
					   <?php } ?>
	...
	<ul class="pagination pagination-sm m-0 float-right">
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_tugas_mata_pelajaran INNER JOIN tbl_siswa INNER JOIN tbl_mata_pelajaran ON tbl_tugas_mata_pelajaran.id_mata_pelajaran = tbl_mata_pelajaran.id_mata_pelajaran WHERE tbl_mata_pelajaran.id_mata_pelajaran = '$id' AND tbl_siswa.nis = '$nip'  AND tbl_tugas_mata_pelajaran.tgl_tugas <= '$tgl_skrang' AND tbl_tugas_mata_pelajaran.batas_pengumpulan >= '$tgl_skrang' ORDER BY tbl_tugas_mata_pelajaran.id_tugas_mata_pelajaran DESC");
