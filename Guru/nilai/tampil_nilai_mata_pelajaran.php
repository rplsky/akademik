						...
						<div class="col-lg-4 col-xs-12">
					          ...
					          <div class="small-box bg-blue">
					            ...
					            <p class="small-box-footer bg-dark">
					                <a href="?page=nilai_mata_pelajaran&aksi=detail_nilai_mata_pelajaran&id=<?php echo $data_mapel['kelas'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>" class="btn__"><i class='bx bx-info-square'></i></a>
					            </p>     
					            </div>
					     </div>
					   <?php } ?>
