<?php
	...
	$query_gurumapel = "SELECT * FROM tbl_guru_mapel WHERE id_mata_pelajaran = '$mapel'";
	$sql_gurumapel = $pdo->prepare($query_gurumapel);
	$sql_gurumapel->execute();
	$data_gurumapel = $sql_gurumapel->fetch();
?>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="row">
						...
						<?php
							while($data = $sql->fetch()){
								...
								?>
										<td><a class="btn btn-warning" href="?page=nilai_mata_pelajaran&aksi=edit_nilai_mata_pelajaran&id=<?php echo $data['nis'];?>&mapel=<?php echo $mapel;?>&nip=<?php echo $data_gurumapel['nip'];?>">Edit Nilai</a></td>
										<td><a class="btn btn-danger" href="?page=nilai_mata_pelajaran&aksi=hapus_tugas_mata_pelajaran&id=<?php echo $data['nis'];?>&mapel=<?php echo $mapel;?>&nip=<?php echo $data_gurumapel['nip'];?>">Hapus Nilai</a></td>
