<?php
	...
	$query = "SELECT * FROM tbl_siswa WHERE kelas = '$id' ORDER BY nis ASC LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			...
			<a class="btn btn-primary" href="nilai/export_nilai_mata_pelajaran.php?id=<?php echo $id;?>&mapel=<?php echo $mapel;?>">Export Nilai</a>
		</h3>
			</div>
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_siswa WHERE kelas = '$id' ORDER BY nis ASC");
