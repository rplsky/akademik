...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			<strong>Data Rekap Absensi Mata Pelajaran - <?php echo $data_mapel['nama_mata_pelajaran']."(".$data_mapel['kelas'].")"; ?></strong><BR>
			<a class="btn btn-primary" href="?page=materi_mata_pelajaran&aksi=hadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>">Siswa Hadir</a> | 
			<a class="btn btn-danger" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>">Siswa Tidak Hadir</a>
		</h3>
			</div>
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=1">First</a></li>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $link_prev; ?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item" <?php echo $link_active; ?>><a  class="page-link" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $link_next; ?>">&raquo;</a></li>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $jumlah_hal; ?>">Last</a></li>
				<?php
				}
				?>
			</ul>
