...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=1">First</a></li>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $link_prev; ?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item" <?php echo $link_active; ?>><a  class="page-link" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $link_next; ?>">&raquo;</a></li>
					<li class="page-item"><a class="page-link" href="?page=materi_mata_pelajaran&aksi=thadir_absensi_mata_pelajaran&id=<?php echo $id;?>&mapel=<?php echo $mapel;?>&hal=<?php echo $jumlah_hal; ?>">Last</a></li>
				<?php
				}
				?>
			</ul>
