					    ...
					    <div class="col-lg-4 col-xs-12">
                            ...
                            <div class="small-box bg-blue">
                                ...
                                <p class="small-box-footer bg-dark">
                                    <a class="btn__" href="?page=materi_mata_pelajaran&aksi=detail_materi_mata_pelajaran&id=<?php echo $data['id_materi_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>"><i class='bx bx-book-reader' ></i></a>
									<a class="btn__" href="?page=materi_mata_pelajaran&aksi=rekapdata_absensi_mata_pelajaran&id=<?php echo $data['id_materi_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>"><i class='bx bxs-user-check' ></i></a>
									<a class="btn__" href="?page=materi_mata_pelajaran&aksi=editdata_materi_mata_pelajaran&id=<?php echo $data['id_materi_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>"><i class='bx bx-edit'></i></a>
									<a onclick="return confirm('Anda akan menghapus data ini?')" class="btn__" href="?page=materi_mata_pelajaran&aksi=hapusdata_materi_mata_pelajaran&id=<?php echo $data['id_materi_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>"><i class='bx bx-trash' style='color:#ffffff' ></i></a>
                                </p>     
                            </div>
                        </div>
                        <?php } ?>
