<?php
	...
	$query = "SELECT * FROM tbl_siswa INNER JOIN tbl_kumpul_tugas ON tbl_kumpul_tugas.nis = tbl_siswa.nis WHERE tbl_kumpul_tugas.id_tugas_mata_pelajaran = '$id' ORDER BY tbl_kumpul_tugas.tgl_kirim ASC LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
	<div class="panel-heading">
							...
							while($data = $sql->fetch()){
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-success" href="?page=tugas_mata_pelajaran&aksi=tambahdata_nilai_mata_pelajaran&id=<?php echo $data['nis'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>&itm=<?php echo $data['id_tugas_mata_pelajaran'];?>">Beri Nilai</a></td>
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_siswa INNER JOIN tbl_kumpul_tugas ON tbl_kumpul_tugas.nis = tbl_siswa.nis WHERE tbl_kumpul_tugas.id_tugas_mata_pelajaran = '$id' ORDER BY tbl_kumpul_tugas.tgl_kirim ASC");
