			...
			<strong>Data Tugas Mata Pelajaran - <?php echo $data_mapel['nama_mata_pelajaran']."(".$data_mapel['kelas'].")"; ?></strong>
				...
				<div class="panel-body">
					...
					<div class="box box-default">
			          ...
			          <div class="box-body">
			          	<p>
			            	<a class="btn btn-info" href="?page=tugas_mata_pelajaran&aksi=rekapdata_tugas_mata_pelajaran&id=<?php echo $data['id_tugas_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>">Rekap Tugas</a>
							<a class="btn btn-warning" href="?page=tugas_mata_pelajaran&aksi=editdata_tugas_mata_pelajaran&id=<?php echo $data['id_tugas_mata_pelajaran'];?>">Edit</a>
							<a onclick="return confirm('Anda akan menghapus data ini?')" class="btn btn-danger" href="?page=tugas_mata_pelajaran&aksi=hapusdata_tugas_mata_pelajaran&id=<?php echo $data['id_tugas_mata_pelajaran'];?>&mapel=<?php echo $data['id_mata_pelajaran'];?>">Delete</a>
			            </p>
