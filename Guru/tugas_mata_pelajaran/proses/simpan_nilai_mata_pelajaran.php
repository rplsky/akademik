		...
		$id_nilai_mata_pelajaran = $huruf . sprintf("%05s", $urutan);
			...
			if($sql){
				...
				<script type="text/javascript">
					...
					setTimeout("location.href='?page=tugas_mata_pelajaran&aksi=rekapdata_tugas_mata_pelajaran&id=<?php echo $id_tugas_mata_pelajaran;?>&mapel=<?php echo $id_mata_pelajaran;?>'", 1000);
				</script>
				<?php
			}else{
				echo $query;
				...
				<script type="text/javascript">
					...
					setTimeout("location.href='?page=tugas_mata_pelajaran&aksi=tambahdata_nilai_mata_pelajaran&id=<?php echo $nis;?>&mapel=<?php echo $id_mata_pelajaran;?>&itm=<?php echo $id_tugas_mata_pelajaran;?>'", 1000);
				</script>
				<?php
			}	
    } else {
