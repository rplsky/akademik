...
<html>
<head>
	<title>Tambah Wks Kurikulum</title>
</head>
<body>
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Tambah Wks Kurikulum</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_wks_kurikulum&aksi=simpandata_wks_kurikulum" method="POST">
						...
						<div class="form-group">
							...
							<input class="form-control" name="nama_wks_kurikulum" required placeholder="Nama Wks Kurikulum"  required />
						</div>
						<div class="form-group">
