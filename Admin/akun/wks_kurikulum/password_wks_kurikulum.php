...
<html>
<head>
	<title>Ganti Password Wks Kurikulum</title>
</head>
<body>
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Ganti Password Wks Kurikulum</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_wks_kurikulum&aksi=updatepassword_wks_kurikulum" method="POST">
						<div class="form-group">
							<label>Password Lama</label>
							<input type="hidden" class="form-control" name="email" value="<?php echo $data['email'];?>" required placeholder="Email Wks Kurikulum"/>
						...
						<a class="btn btn-default" href="?page=akun_wks_kurikulum&aksi=aktif" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
