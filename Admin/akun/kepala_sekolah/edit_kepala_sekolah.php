...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Edit Kepala Sekolah</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_kepala_sekolah&aksi=updatedata_kepala_sekolah" method="POST">
						<div class="form-group">
							<label>Nama Kepala Sekolah</label>
							<input type="hidden" class="form-control" name="nip" value="<?php echo $data['nip'];?>" required placeholder="NIP Kepala Sekolah"/>
							<input class="form-control" name="nama_kepala_sekolah" value="<?php echo $data['nama_kepala_sekolah'];?>" required placeholder="Nama Kepala Sekolah"/>
						</div>
						<div class="form-group">
						...
						<a class="btn btn-default" href="?page=akun_kepala_sekolah&aksi=detail_kepala_sekolah" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
