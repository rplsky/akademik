...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Tambah Kepala Sekolah</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_kepala_sekolah&aksi=simpandata_kepala_sekolah" method="POST">
						...
						<div class="form-group">
							...
							<input class="form-control" name="nama_kepala_sekolah" required placeholder="Nama Kepala Sekolah"  required />
						</div>
						<div class="form-group">
