...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_admin&aksi=updatedata_admin" method="POST">
						<div class="form-group">
							<label>Nama Admin</label>
							<input type="hidden" class="form-control" name="nip" value="<?php echo $data['nip'];?>" required placeholder="NIP Admin"/>
							<input class="form-control" name="nama_admin" value="<?php echo $data['nama_admin'];?>" required placeholder="Nama Admin"/>
						</div>
						<div class="form-group">
						...
						<a class="btn btn-default" href="?page=akun_admin&aksi=detail_admin" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
