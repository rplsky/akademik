...
<div class="panel panel-default">
	<div class="panel-heading">
							...
							while($data = $sql->fetch()){
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-warning" href="?page=akun_admin&aksi=editdata_admin&id=<?php echo $data['nip'];?>">Edit</a></td>
										<td><a onclick="return confirm('Anda akan menghapus data ini?')" class="btn btn-danger" href="?page=akun_admin&aksi=hapusdata_admin&id=<?php echo $data['nip'];?>">Delete</a></td>
									</tr>
								</tbody>
								<?php
							}
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=akun_admin&aksi=detail_admin&hal=1&id=<?php echo $id;?>">First</a></li>
					<li class="page-item"><a class="page-link" href="?page=akun_admin&aksi=detail_admin&hal=<?php echo $link_prev; ?>&id=<?php echo $id;?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_admin WHERE nip = '$id'");
				...
				?>
					<li class="page-item" <?php echo $link_active; ?>><a  class="page-link" href="?page=akun_admin&aksi=detail_admin&hal=<?php echo $i; ?>&id=<?php echo $id;?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=akun_admin&aksi=detail_admin&hal=<?php echo $link_next; ?>&id=<?php echo $id;?>">&raquo;</a></li>
					<li class="page-item"><a class="page-link" href="?page=akun_admin&aksi=detail_admin&hal=<?php echo $jumlah_hal; ?>&id=<?php echo $id;?>">Last</a></li>
				<?php
				}
				?>
			</ul>
