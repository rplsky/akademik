...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Ganti Password Admin</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_admin&aksi=updatepassword_admin" method="POST">
						<div class="form-group">
							<label>Password Lama</label>
							<input type="hidden" class="form-control" name="email" value="<?php echo $data['email'];?>" required placeholder="email Admin"/>
