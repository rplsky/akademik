...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Tambah Guru</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_guru&aksi=simpandata_guru" method="POST">
						...
						<div class="form-group">
							...
							<input class="form-control" name="nama_guru" required placeholder="Nama Guru"  required />
						</div>
						<div class="form-group">
