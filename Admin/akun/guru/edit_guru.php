...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Edit Guru</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_guru&aksi=updatedata_guru" method="POST">
						<div class="form-group">
							<label>Nama Guru</label>
							<input type="hidden" class="form-control" name="nip" value="<?php echo $data['nip'];?>" required placeholder="NIP Guru"/>
							<input class="form-control" name="nama_guru" value="<?php echo $data['nama_guru'];?>" required placeholder="Nama Guru"/>
						</div>
						<div class="form-group">
						...
						<a class="btn btn-default" href="?page=akun_guru&aksi=detail_guru" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
