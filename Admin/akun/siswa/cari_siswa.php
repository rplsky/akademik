<?php
	...
	$query = "SELECT * FROM tbl_akun INNER JOIN tbl_siswa ON tbl_akun.nip = tbl_siswa.nis WHERE tbl_akun.hak_akses = 'Siswa' AND tbl_siswa.nama_siswa LIKE '%$cari%' ORDER BY tbl_siswa.kelas ASC, tbl_siswa.nis ASC LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<ul class="pagination pagination-sm m-0 float-right">
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=akun_siswa&aksi=cari_siswa&hal=1">First</a></li>
					<li class="page-item"><a class="page-link" href="?page=akun_siswa&aksi=cari_siswa&hal=<?php echo $link_prev; ?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				$sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM tbl_akun INNER JOIN tbl_siswa ON tbl_akun.nip = tbl_siswa.nis WHERE tbl_akun.hak_akses = 'Siswa'  AND tbl_siswa.nama_siswa LIKE '%$cari%' ORDER BY tbl_siswa.nis ASC, tbl_siswa.kelas ASC");
				$sql2->execute(); // Eksekusi querynya
				$get_jumlah = $sql2->fetch();
				
				$jumlah_hal = ceil($get_jumlah['jumlah'] / $limit); // Hitung jumlah halamannya
				$jumlah_number = 3; // Tentukan jumlah link number sebelum dan sesudah hal yang cari_siswa
				...
				?>
					<li class="page-item" <?php echo $link_active; ?>><a  class="page-link" href="?page=akun_siswa&aksi=cari_siswa&hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item"><a class="page-link" href="?page=akun_siswa&aksi=cari_siswa&hal=<?php echo $link_next; ?>">&raquo;</a></li>
					<li class="page-item"><a class="page-link" href="?page=akun_siswa&aksi=cari_siswa&hal=<?php echo $jumlah_hal; ?>">Last</a></li>
				<?php
				}
				?>
			</ul>
